...
@section('title', 'Авторизация - Nekomi')
...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="glass-card p-8 rounded-2xl w-full max-w-md relative overflow-hidden">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-white mb-2">Добро пожаловать!</h1>
            <p class="text-zinc-400 text-sm">Введите свои учетные данные, чтобы получить доступ к своей учетной записи</p>
        </div>
        ...
        <form action="{{ url('/login') }}" method="POST" class="space-y-4">
            ...
            <div>
                <div class="flex justify-between items-center mb-1.5">
                    <label class="block text-xs font-medium text-zinc-400 uppercase tracking-wider">Пароль</label>
                    <a href="#" class="text-xs text-blue-400 hover:text-blue-300">Забыли?</a>
                </div>
        ...
        <div class="mt-6 pt-6 border-t border-white/5 text-center">
            <p class="text-zinc-500 text-sm">
                У вас нет аккаунта? 
                <a href="{{ route('register') }}" class="text-blue-400 hover:text-blue-300 font-medium transition-colors">Зарегистрироваться</a>
            </p>
        </div>
    </div>
</div>
